...
<!--  col-2 col-md-1 col-xl-2">-->
        <div class="list-group">
            ...
            ${
        links.map(link => `
            <a href=${link.href} class="list-group-item list-group-item-action ps-md-1 ps-lg-2 ${link.title === active ? 'active' : ''}">
                <div class="float-start pe-1">
                <i class=${link.icon}></i>
                </div>
                <div class="d-none d-xl-block d-inline-block">${link.title}</div>
            </a>
          `).join('')
    }
